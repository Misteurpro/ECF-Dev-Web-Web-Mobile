...
<body>
    ...
    <div class="margin-12">
        <H1>Le personnage a été <?php echo $is_unsuspend ?></H1>
        <p>Le personnage a été <?php echo $is_unsuspend ?> avec succès, veuillez revenir sur la page administrateur, <a href="/admin/liste-personnage">cliquez-ici</a></p>
    </div>
